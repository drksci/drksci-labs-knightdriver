...
let ArduinoNanoElement = class ArduinoNanoElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led13 = false;
        this.ledRX = false;
    ...
    render() {
      ...
      >
        ...
        <g transform="translate(27.7 5)">
          ...
          ${ledTX &&
            lit_element_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#ff8080" filter="url(#ledFilter)" />`}
        </g>
        <g transform="translate(27.7 7)">
          <use xlink:href="#led-body" />
          ${ledRX &&
            lit_element_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#80ff80" filter="url(#ledFilter)" />`}
        </g>
        ...
        <g transform="translate(27.7 11)">
          <use xlink:href="#led-body" />
          ${led13 &&
            lit_element_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#ffff80" filter="url(#ledFilter)" />`}
        </g>
...
__decorate([
    lit_element_1.query('#reset-button')
], ArduinoNanoElement.prototype, "resetButton", void 0);
ArduinoNanoElement = __decorate([
    lit_element_1.customElement('wokwi-arduino-nano')
], ArduinoNanoElement);
