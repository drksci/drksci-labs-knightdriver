...
let ESP32DevkitV1Element = class ESP32DevkitV1Element extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led1 = false;
        this.ledPower = false;
    ...
    render() {
      ...
      >
        ...
        <g stroke-width="1.44">
          ...
          ${ledPower &&
            lit_element_1.svg `<circle cx="37" cy="112.5" r="4" fill="red" filter="url(#ledFilter)" />`}

          <rect x="69.5" y="108" width="3.83" height="9.3" fill="#e5e5e5" />
          <rect x="69.5" y="110" width="3.83" height="5.31" fill="#f5ecde" />
          ${led1 && lit_element_1.svg `<circle cx="71.5" cy="112.5" r="4" fill="blue" filter="url(#ledFilter)" />`}
        </g>
...
ESP32DevkitV1Element = __decorate([
    lit_element_1.customElement('wokwi-esp32-devkit-v1')
