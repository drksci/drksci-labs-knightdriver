...
let NanoRP2040ConnectElement = class NanoRP2040ConnectElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledRed = 0;
        this.ledGreen = 0;
    ...
    render() {
      ...
      >
        ...
        <g stroke-width="1.24">
          ...
          ${ledBuiltIn &&
            lit_element_1.svg `<circle cx="14.5" cy="14.5" r="3" fill="red" filter="url(#ledFilter)" />`}

          <!-- LED POWER -->
          <rect x="11.9" y="50.9" width="4.94" height="4.06" fill="#f1d99f" />
          ${ledPower &&
            lit_element_1.svg `<circle cx="14.5" cy="53" r="3" fill="#80ff80" filter="url(#ledFilter)" />`}
...
NanoRP2040ConnectElement = __decorate([
    lit_element_1.customElement('wokwi-nano-rp2040-connect')
