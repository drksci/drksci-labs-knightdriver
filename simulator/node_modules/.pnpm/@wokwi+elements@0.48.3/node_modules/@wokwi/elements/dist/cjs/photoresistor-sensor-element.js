...
let PhotoresistorSensorElement = class PhotoresistorSensorElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledDO = false;
        this.ledPower = false;
    ...
    render() {
      ...
      >
        ...
        ${ledPower && lit_element_1.svg `<circle cx="124.5" cy="7" r="4" fill="green" filter="url(#ledFilter)" />`}

        <rect x="118" y="52.6" width="13" height="4.29" fill="#dae3eb" />
        <rect x="121" y="52.5" width="6.55" height="4.59" fill="#fffefe" />
        ${ledDO && lit_element_1.svg `<circle cx="124.5" cy="55" r="4" fill="red" filter="url(#ledFilter)" />`}
...
PhotoresistorSensorElement = __decorate([
    lit_element_1.customElement('wokwi-photoresistor-sensor')
