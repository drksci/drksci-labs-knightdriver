...
let FlameSensorElement = class FlameSensorElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledPower = false;
    ...
    render() {
      ...
      >
        ...
        ${ledPower &&
            lit_element_1.svg `<circle cx="153.2" cy="7.5" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
        <rect x="145" y="48.3" width="16.7" height="5.52" fill="#dae3eb" />
        <rect x="149" y="48.1" width="8.43" height="5.9" fill="#fffefe" />
        ${ledSignal &&
            lit_element_1.svg `<circle cx="153.2" cy="51.3" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
...
FlameSensorElement = __decorate([
    lit_element_1.customElement('wokwi-flame-sensor')
], FlameSensorElement);
