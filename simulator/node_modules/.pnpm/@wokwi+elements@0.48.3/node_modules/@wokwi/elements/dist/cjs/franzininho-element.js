...
let FranzininhoElement = class FranzininhoElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led1 = false;
        this.ledPower = false;
    ...
    render() {
      ...
      >
        ...
        ${ledPower &&
            lit_element_1.svg `<circle cx="33.6" cy="25.9" r="1.8" fill="#03f704" filter="url(#ledFilter)" />`}
        ...
        ${led1 &&
            lit_element_1.svg `<circle cx="38.35" cy="25.9" r="1.8" fill="#fcfd00" filter="url(#ledFilter)" />`}
...
FranzininhoElement = __decorate([
    lit_element_1.customElement('wokwi-franzininho')
], FranzininhoElement);
