...
let RotaryDialerElement = class RotaryDialerElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.digit = '';
        this.stylesMapping = {};
    ...
    render() {
      ...
      <svg width="266" height="266" @click="${this.focusInput}" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(1 1)">
          ...
          <path
            class=${class_map_1.classMap(this.classes)}
            @transitionstart="${() => {
            ...
            fill-opacity="0.5"
            fill="#D8D8D8"
            style=${style_map_1.styleMap(this.stylesMapping)}
          ></path>
        </g>
...
RotaryDialerElement = __decorate([
    lit_element_1.customElement('wokwi-rotary-dialer')
], RotaryDialerElement);
