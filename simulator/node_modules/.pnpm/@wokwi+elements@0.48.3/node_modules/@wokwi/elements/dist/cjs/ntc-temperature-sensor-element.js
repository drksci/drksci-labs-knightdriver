...
let NTCTemperatureSensorElement = class NTCTemperatureSensorElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
...
NTCTemperatureSensorElement = __decorate([
    lit_element_1.customElement('wokwi-ntc-temperature-sensor')
