...
let SevenSegmentElement = class SevenSegmentElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
      ...
      >
        <defs>
          <pattern id="pin-pattern" height="2" width="2.54" patternUnits="userSpaceOnUse">
            ${pins === 'extend'
            ? lit_element_1.svg `<rect x="1.02" y="0" height="2" width="0.5" fill="#aaa" />`
            : lit_element_1.svg `<circle cx="1.27" cy="1" r=0.5 fill="#aaa" />`}
          </pattern>
        </defs>
...
SevenSegmentElement = __decorate([
    lit_element_1.customElement('wokwi-7segment')
], SevenSegmentElement);
