...
let SmallSoundSensorElement = class SmallSoundSensorElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledPower = false;
    ...
    render() {
      ...
      >
        ...
        ${ledPower && lit_element_1.svg `<circle cx="56" cy="4" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
        ...
        ${ledSignal &&
            lit_element_1.svg `<circle cx="56" cy="47" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
...
SmallSoundSensorElement = __decorate([
    lit_element_1.customElement('wokwi-small-sound-sensor')
