...
let BigSoundSensorElement = class BigSoundSensorElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led1 = false;
        this.led2 = false;
    ...
    render() {
      ...
      >
        ...
        ${led2 && lit_element_1.svg `<circle cx="56" cy="4" r="5" fill="#80ff80" filter="url(#ledFilter)" />`}
        ...
        ${led1 && lit_element_1.svg `<circle cx="56" cy="47" r="5" fill="#80ff80" filter="url(#ledFilter)" />`}
...
BigSoundSensorElement = __decorate([
    lit_element_1.customElement('wokwi-big-sound-sensor')
