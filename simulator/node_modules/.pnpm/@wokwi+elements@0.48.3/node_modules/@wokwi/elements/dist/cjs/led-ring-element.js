...
const pinHeight = 3;
const pcbWidth = 6;
let LEDRingElement = class LEDRingElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        /**
    ...
    render() {
        ...
        for (let i = 0; i < pixels; i++) {
            ...
            pixelElements.push(lit_element_1.svg `<rect
          class="pixel"
          x="${radius - 2.5}"
          y="${pcbWidth / 2 - 2.5}"
          width="5"
...
LEDRingElement = __decorate([
    lit_element_1.customElement('wokwi-led-ring')
], LEDRingElement);
