...
let MPU6050Element = class MPU6050Element extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led1 = false;
        this.pinInfo = [
    ...
    render() {
      ...
      >
        ...
        ${led1 &&
            lit_element_1.svg `<circle cx="13.9" cy="25.5" r="3.5" fill="#80ff80" filter="url(#ledFilter)" />`}
...
MPU6050Element = __decorate([
    lit_element_1.customElement('wokwi-mpu6050')
], MPU6050Element);
