...
export declare class SevenSegmentElement extends LitElement {
    ...
    private get yOffset();
    renderDigit(x: number, startIndex: number): import("lit-element").SVGTemplateResult;
    renderColon(): import("lit-element").SVGTemplateResult;
    renderPins(): import("lit-element").SVGTemplateResult;
